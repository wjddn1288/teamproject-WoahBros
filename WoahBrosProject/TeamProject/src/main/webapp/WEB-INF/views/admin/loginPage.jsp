...
<link rel="icon" type="image/x-icon"
	href="/resources/admin/assets/img/favicon/favicon.ico" />
...
<link rel="stylesheet"
	href="/resources/admin/assets/vendor/fonts/boxicons.css" />

<!-- Core CSS -->
<link rel="stylesheet"
	href="/resources/admin/assets/vendor/css/core.css"
	class="template-customizer-core-css" />
<link rel="stylesheet"
	href="/resources/admin/assets/vendor/css/theme-default.css"
	class="template-customizer-theme-css" />
<link rel="stylesheet" href="/resources/admin/assets/css/demo.css" />

<!-- Vendors CSS -->
<link rel="stylesheet"
	href="/resources/admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />

<!-- Page CSS -->
<!-- Page -->
<link rel="stylesheet"
	href="/resources/admin/assets/vendor/css/pages/page-auth.css" />
<!-- Helpers -->
...
<script>
	$(function() {
		$("#bt_login").click(function() {
			...
			//폼 내부의 데이터를 전송할 주소
			document.form1.action = "${path}/admin/main";
...
<body>
				...
				<div class="card">
					<div class="card-body">
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
						...
						<form class="mb-3" name="form1" method="post">
							<div class="mb-3">
							...
							<!-- 버튼 타입 submit -->
							<div class="mb-3">
								<button class="btn btn-primary d-grid w-100" type="button" id="bt_login"> Sign in </button>
	...
	<script
		src="/resources/admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
