...
<% 
	...
	List<Service> serviceList = (List)request.getAttribute("serviceList"); 
	pm.init(serviceList, request);
%>
<!DOCTYPE html>
					...
					<div class="row">
						...
						<div class="table-responsive text-nowrap">
							<table class="table table-striped">
								...
								<%if(num<1)break; %>
								<%Service service = serviceList.get(curPos++); %>
									<tr>
										<td><i class="fab fa-angular fa-lg text-danger me-3"></i>
											<strong><%=num-- %></strong></td>
										<td><a id="bt_detail" href="/admin/service/detail?service_idx=<%=service.getService_idx()%>"><%=service.getTitle() %></a></td>
										<td><%=service.getRegdate().substring(0,10) %></td>
										<td><%=service.getMax() %>명</td>
										<td>0명</td>
									</tr>
								<%} %>
								</tbody>
										...
										<nav aria-label="Page navigation">
											<ul class="pagination">
												...
												<li class="page-item prev"><a class="page-link"
													href="/admin/service/list?currentPage=<%=pm.getFirstPage()-1%>"><i
												...
												<%if(pm.getTotalPage()> pm.getLastPage()+1){ %>
													<li class="page-item next"><a class="page-link"
														href="/admin/service/list?currentPage=<%=pm.getLastPage()+1%>"><i
...
$(function(){
	$("#bt_regist").click(function(){
		location.href="/admin/service/registform";
	});
