...
<%
	...
	//System.out.println(productList + "List.jsp productList");
%>
								...
								<tbody class="table-border-bottom-0">
									...
									<% for (int a = 0; a <pm.getPageSize(); a++) {%>
											...
											<tr>
												...
												<td><a id="bt_detail" href="/admin/product/detail?product_idx=<%=product.getProduct_idx()%>"
													name="name"><%=product.getName()%></a></td>
										...
										<div class="col">
											<nav aria-label="Page navigation">
												<ul class="pagination">
													...
													<li class="page-item <%if (a == pm.getCurrentPage()) {%>active<%}%>"><a
														class="page-link" href=" list?currentPage=<%=a%>"><%=a%></a></li>
													<%}%>
