...
<aside id="layout-menu"
	...
	<div class="app-brand demo">
		<a href="/admin/main" class="app-brand-link"> <span
	...
	<ul class="menu-inner py-1">
		...
		<li class="menu-header small text-uppercase"><span
			class="menu-header-text">관리자 인증</span></li>
		<!-- Layouts -->
		<li class="menu-item"><a href="/admin/loginform"
			class="menu-link"> <i
				class="menu-icon tf-icons bx bx-lock-open-alt"></i>
				<div data-i18n="Layouts">인증</div>
		</a></li>

		<li class="menu-header small text-uppercase"><span
			class="menu-header-text">업무</span></li>
		<li class="menu-item"><a class="menu-link menu-toggle"> <i
	...
	<li class="menu-item"><a href="javascript:void(0);"
		class="menu-link menu-toggle"> <i
			...
			<div data-i18n="Misc">쇼핑몰</div>
	</a>
		<ul class="menu-sub">
<!-- 			<li class="menu-item"><a href="/admin/product/category"
				class="menu-link">
					<div data-i18n="Basic">카테고리등록</div>
			</a></li>		 -->
			<li class="menu-item"><a href="/admin/product/registForm"
				class="menu-link">
					<div data-i18n="Basic">상품등록</div>
			</a></li>
			<li class="menu-item"><a href="/admin/product/list"
				class="menu-link">
					<div data-i18n="Basic">상품목록</div>
			</a></li>
			<li class="menu-item"><a href="/admin/orderList"
				class="menu-link">
					<div data-i18n="Basic">구매현황</div>
			</a></li>
			<li class="menu-item"><a href="/admin/summery" class="menu-link">
					<div data-i18n="Basic">통계</div>
			</a></li>
			</a></li>
	</ul>
	</li>
	...
	<!-- Misc -->
	<li class="menu-header small text-uppercase"><span
		class="menu-header-text">Support</span></li>
